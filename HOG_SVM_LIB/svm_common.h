...
typedef struct svector {
  _WORD    *words;              /* The features/values in the vector by
...
SVECTOR *create_svector(_WORD *, char *, double);
...
long int *totwords, long int *totdoc, const int *map, int lengthMap, double classLabel);
int parse_linear_weight(char *line, double *lin_weights, long length);
int    parse_document(char *, _WORD *, double *, long *, long *, double *, long *, long, char **);
